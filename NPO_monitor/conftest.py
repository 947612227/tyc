...
def send_msg_text(msg_text):
    ...
    web_hook_url = "https://open.feishu.cn/open-apis/bot/v2/hook/6fbd7c64-f0ee-4397-8ff1-e1470529b991"#自测推送地址
    ...
    requests.post(url=web_hook_url, data=json.dumps(data),verify=False)
